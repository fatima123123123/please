                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        label: const Text('Full Name', style: TextStyle(fontSize: 20.0)),
                        hintText: 'Enter your full name',
                        hintStyle: const TextStyle(color: Colors.black26, fontSize: 18.0),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        label: const Text('Email', style: TextStyle(fontSize: 20.0)),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        label: const Text('Password', style: TextStyle(fontSize: 20.0)),
